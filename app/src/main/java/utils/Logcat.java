...
import com.speedata.print.BuildConfig;
...
public final class Logcat {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = ApplicationContext.getInstance().getPackageManager()
                    .getPackageInfo(ApplicationContext.getInstance().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && ApplicationContext.getInstance().getExternalCacheDir() != null) {
                sDefaultDir = ApplicationContext.getInstance().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            } else {
                sDefaultDir = ApplicationContext.getInstance().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
