...
//				 context.getObject().CON_SetPrintDirection(context.getState(),false,0,0);
    ...
    public void printTable(View view) {
        ...
        str.add("单价");
        str.add("小计");
        context.getObject().ASCII_PrintTabString(context.getState(), new byte[]{10, 18, 26, 34}, str, "gb2312");
        context.getObject().ASCII_CtrlPrintCRLF(context.getState(), 1);
        context.getObject().ASCII_PrintString(context.getState(), 0,
                0, 0, 0, 0, "----------------------------",
                "gb2312");
        ...
        str1.add("105.00");
        str1.add("105.00");
        context.getObject().ASCII_PrintTabString(context.getState(), new byte[]{10, 18, 26, 34}, str1, "gb2312");
        context.getObject().ASCII_CtrlPrintCRLF(context.getState(), 1);
        context.getObject().ASCII_PrintTabString(context.getState(), new byte[]{10, 18, 26, 34}, str1, "gb2312");
        context.getObject().ASCII_CtrlPrintCRLF(context.getState(), 1);
        context.getObject().ASCII_PrintTabString(context.getState(), new byte[]{10, 18, 26, 34}, str1, "gb2312");
        ...
        context.getObject().ASCII_CtrlPrintCRLF(context.getState(), 1);
        context.getObject().ASCII_PrintString(context.getState(), 0,
                0, 0, 0, 0, "合计:￥315.00元", "gb2312");
        context.getObject().ASCII_CtrlPrintCRLF(context.getState(), 1);
        context.getObject().ASCII_PrintString(context.getState(), 0,
                0, 0, 0, 0, "优惠金额:￥0.00元", "gb2312");
        context.getObject().ASCII_CtrlPrintCRLF(context.getState(), 1);
        context.getObject().ASCII_PrintString(context.getState(), 0,
                0, 0, 0, 0, "电话：01062985019", "gb2312");
        context.getObject().ASCII_CtrlPrintCRLF(context.getState(), 1);
